...
nav_order: 5
permalink: /first-payment/
description: "Make your first EcoCash sandbox payment with cURL: charge a wallet, approve the USSD PIN prompt, look up the status and refund it, in four steps."
date: 2026-09-21
last_modified_at: 2026-09-21
seo:
  type: WebPage
image:
  path: /assets/og/first-payment.png
  width: 1200
  height: 630
  alt: "Your first payment - EcoCash EIP Developer Guide"
...
Set these first. Use a **verified** test number from [step 2.5](../getting-started/#25-verify-a-test-number):
...
app with the [code examples](../sdks/).
...
| Merchant values | Your Authentication tab's *Credential Reference* set | The Documentation's Test Data set ([7.3](../testing/#73-sandbox-merchant-values)) |

Background on each is in [Known portal inconsistencies](../known-issues/).


---

This page is generated from section 4 of the README in [`README.md`](https://github.com/67even/ecocash-instant-payment-api/blob/main/README.md). Spotted something wrong? [Open an issue](https://github.com/67even/ecocash-instant-payment-api/issues).
