...
nav_order: 8
permalink: /testing/
description: "Test EcoCash payments in the sandbox: PIN test matrix, whitelisted test numbers, sandbox merchant values, SMS notifications and the TC-001 to TC-006 checklist."
date: 2026-09-21
...
image:
  ...
  width: 1200
  height: 630
  alt: "Sandbox testing - EcoCash EIP Developer Guide"
...
- Only **whitelisted, OTP-verified** numbers can be charged or receive sandbox SMS
  ([step 2.5](../getting-started/#25-verify-a-test-number)).
...
This page is generated from section 7 of the README in [`README.md`](https://github.com/67even/ecocash-instant-payment-api/blob/main/README.md). Spotted something wrong? [Open an issue](https://github.com/67even/ecocash-instant-payment-api/issues).
