...
nav_order: 9
permalink: /sdks/
description: "EcoCash EIP API code examples in PHP/Laravel, Node.js, Python, Java Spring and C# .NET, plus the pitfalls in the portal's official SDK samples."
date: 2026-09-21
last_modified_at: 2026-09-21
seo:
  type: WebPage
image:
  path: /assets/og/sdks.png
  width: 1200
  height: 630
  alt: "SDKs & code examples - EcoCash EIP Developer Guide"
...
- reads every value from configuration ([3.2](../authentication/#32-store-credentials-safely))
...
- keeps the [three first-run details](../first-payment/#45-confirm-three-details-in-your-first-run) (amount
...
[`reference/ECOCASH-EIP-SDK-REFERENCE.md`](../reference/sdks-tab/).
...
| **Refunds send `tranType: "MER"`** plus an undocumented `currencyCode` | All 15 refund samples | See [4.5](../first-payment/#45-confirm-three-details-in-your-first-run) |
| **`amount` is a string** (`"5.00"`) | All 15 | Fine. Keep it consistent ([4.5](../first-payment/#45-confirm-three-details-in-your-first-run)). |
...
This page is generated from section 8 of the README in [`README.md`](https://github.com/67even/ecocash-instant-payment-api/blob/main/README.md). Spotted something wrong? [Open an issue](https://github.com/67even/ecocash-instant-payment-api/issues).
