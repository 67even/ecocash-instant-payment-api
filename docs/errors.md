...
nav_order: 7
permalink: /errors/
description: "EcoCash EIP transaction statuses and error codes E001 to E015: what each means, how to fix it, which to retry, and rules that prevent double charges."
date: 2026-09-21
last_modified_at: 2026-09-21
seo:
  type: WebPage
image:
  path: /assets/og/errors.png
  width: 1200
  height: 630
  alt: "Statuses & errors - EcoCash EIP Developer Guide"
...
|---|---|---|---|---|
| `E001` | 400 | Missing required field | Send every field in the [request body](../api-reference/#51-charge-request) | No |
...
This page is generated from section 6 of the README in [`README.md`](https://github.com/67even/ecocash-instant-payment-api/blob/main/README.md). Spotted something wrong? [Open an issue](https://github.com/67even/ecocash-instant-payment-api/issues).
