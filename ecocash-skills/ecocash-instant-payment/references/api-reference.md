<!-- GENERATED by tools/build_skill.py from README.md section 5 - edit the source, then re-run it. -->

# API reference

> Every endpoint, request field, response field and HTTP status.
...
Also handle `403`, `404`, `409` and `503`. See [Error codes](statuses-and-errors.md#62-error-codes).
...
| `tranType` | string | ✅ | `REF` (refund) or `REV` (reversal). See [4.5](first-payment.md#45-confirm-three-details-in-your-first-run). |
