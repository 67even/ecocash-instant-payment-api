<!-- GENERATED by tools/build_skill.py from README.md section 11 - edit the source, then re-run it. -->

# Known portal inconsistencies

> Where the portal contradicts itself, and the open questions.
